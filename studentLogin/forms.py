...
class advisorUserForm(UserCreationForm):
    # Define additional fields specific to students
    advisorId = forms.CharField(widget=forms.TextInput(attrs={'class': 'form-control'}), max_length=20)
    advisorName = forms.CharField(widget=forms.TextInput(attrs={'class': 'form-control'}), max_length=50)
    advisorPhone = forms.CharField(widget=forms.TextInput(attrs={'class': 'form-control'}), max_length=50)
    advisorEmail = forms.CharField(widget=forms.TextInput(attrs={'class': 'form-control'}), max_length=50)

    class Meta:
        model = User
        fields = ('username', 'advisorName', 'advisorPhone', 'advisorId', 'advisorEmail', 'password1', 'password2')
